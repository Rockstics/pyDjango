"""
Django settings for sqlmanager project.
...
SECRET_KEY = 'j5^d^u+jewl^6k#ws7)9am&ac1pkf*6rq@0!!!!^)0hmd9gh#y'
...
ROOT_URLCONF = 'sqlmanager.urls'
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, '../sqlmanager/templates')],
...
WSGI_APPLICATION = 'sqlmanager.wsgi.application'
# Database
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, '../sqlmanager/static')
]
